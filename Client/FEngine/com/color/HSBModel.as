package com.color {
	...
	public class HSBModel {
		...
		public function HSBModel(h : Number = NaN, s : Number = NaN,b : Number = NaN) {
			hue = h;
			saturation = s;
			brightness = b;
		}
		...
		public static function convertRGBtoHSB(rgb : uint) : HSBModel {
			...
			return new HSBModel(hue, saturation, brightness);
		}
	}
}