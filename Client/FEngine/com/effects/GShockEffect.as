package com.effects {
	...
	public class GShockEffect extends GEffect {
		...
		public function GShockEffect(delay : int = 50) {
			super(delay);
			_offsetX = 2;
			_offsetY = 2;
		...
		override public function start() : void {
			...
			_bd = BDUtil.BitmapCreator(w, h, true, 0);
			_spark_bd = BDUtil.BitmapCreator(w, h, true, 0);
			...
			_show_bd = BDUtil.BitmapCreator(w, h);
