package com.model {
	 ...
	 * @version 2010630
	 */
	public class PageModel extends EventDispatcherEx {
		...
		public function currentPageContent():Array
		{
			var ary : Array = new Array();
			for ( var idx : int = (currentPage - 1) * pageSize; idx < (currentPage*pageSize > _listModel.size? _listModel.size:currentPage*pageSize);idx++)
			{
				ary.push(_listModel.getAt(idx));
			}
			return ary;
		}
