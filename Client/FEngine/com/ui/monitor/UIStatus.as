package com.ui.monitor 
{
	...
	import com.ui.data.UIStatsData;
	...
	{	
		...
		override protected function create() : void {
			...
			_graph = new Bitmap();
			_graph.y = 50;
			_graph.bitmapData = BDUtil.BitmapCreator(_data.width, _data.height - 50, false, _data.bgColor);
		...
		public function UIStatus(data : UIStatsData) {
			_data = data;
			super(_data);
		}
