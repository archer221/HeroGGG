package com.ui.controls {
	...
	public class Label extends UIComponent {
		...
		public var _data : LabelData;

		protected var _icon : Icon;
		protected var _back:Number = 0;
		...
		override protected function create() : void {
			...
			_textField.multiline = _data.multiLine;
		...
		override protected function layout() : void {
			...
			if(_data.iconY == 0) {
				_icon.y = int((_height - iconH) * 0.5)+6;
			} else {
				_icon.y = _textField.y + rect.y + rect.height + _data.iconY - iconH+6;
			}
			_textField.x = (iconW == 0 ? 0 : iconW + _data.hGap);
			_icon.moveTo(_textField.x - (iconW-textW)/2, _icon.y);
		...
		public function set Nummber(value:Number):void {
			_back = value;
		}
		
		public function set filter(value:uint):void {
			_textField.filters = UIManager.getEdgeFilters(value,_back);
		}
