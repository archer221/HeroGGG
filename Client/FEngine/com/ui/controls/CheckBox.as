package com.ui.controls {
	...
	public class CheckBox extends UIComponent {
		...
		override protected function layout() : void {
			...
			var _iconwidth : int = _icon.width;
			var _iconheight : int = _icon.height;
			if (_selected_upIcon != null)
			{
				_iconwidth = _selected_upIcon.width;
				_iconheight = _selected_upIcon.height;
			}
			_width = _iconwidth + _data.hGap + _label.width + _data.padding * 2;
			_height = Math.max(_iconheight, _label.height) + _data.padding * 2;
			_icon.y = Math.floor((_height - _iconheight) / 2);
