package com.ui.controls {
	...
	public class PowerBar extends UIComponent {
		...
		override protected function create() : void {
			...
			//_barSkin.width = 0;
			_barSkin.scrollRect = new Rectangle(0, 0, 0, _barSkin.height);
		...
		public function get TrackSkin():Sprite {
			return _tipSkin;
		}
		
		public function  get BarSkin():Sprite {
			return _barSkin;
		}
		...
		private function updateBar() : void {
			...
			_barSkin.scrollRect = new Rectangle(0, 0, _model.percent * _width, _barSkin.height);//new Rectangle(0, 0, _model.percent * _width, _barSkin.height);
		}
