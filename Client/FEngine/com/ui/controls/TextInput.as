package com.ui.controls {
	...
	public class TextInput extends UIComponent {
		...
		private function textInputHandler(event : TextEvent) : void {
			if(_textField.selectionEndIndex <= _textField.selectionBeginIndex && _data.maxChars > 0 && GStringUtil.getDwordLength(_textField.text) + GStringUtil.getDwordLength(event.text) > _data.maxChars) {
		...
		private function focusInHandler(event : FocusEvent) : void {
			...
			//if (BztcUIManager.instance.IsShow("chat") && BztcUIManager.Chat.chatinput._IsMenu ==false) {
				//BztcUIManager.Chat.chatinput._IsMenu = true;
			//}
			//if (BztcUIManager.instance.IsShow("bar") && BztcUIManager.barrroomPanel.barchatinput._IsMenu ==false) {
				//BztcUIManager.barrroomPanel.barchatinput._IsMenu =true
			//}
			//if ( BztcUIManager.instance.IsShow("fight")  && BztcUIManager.gameViw.battleview._chatinput._IsMenu ==false) {
				//BztcUIManager.gameViw.battleview._chatinput._IsMenu = true;
			//}
			dispatchEvent(event);
		}
